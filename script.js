document.addEventListener("DOMContentLoaded", () => {
    ...
    // --- 0. UTILITIES & LOGGING (MUST BE FIRST) ---
    ...
    const btnLoadMapLayout = document.getElementById('btnLoadMapLayout'); // 🆕
    ...
    // 🆕 MAP LAYOUT PRESET BUTTON LOGIC
    btnLoadMapLayout.addEventListener('click', () => {
        const mapLayout = [
          {
            "x": 0, "y": 0, "w": 12, "h": 6,
            "title": "Map", "type": "Map",
            "config": { "indexes": ["0", "1"], "locked": true }
          }
        ];
        ...
        try {
            ...
            mapLayout.forEach(item => {
                ...
                grid.addWidget(widgetEl, { 
                    ...
                    noMove: isLocked, noResize: isLocked
                });
            });
            logToConsole("Loaded Map Layout Preset.", "success");
        } catch (err) { logToConsole("Error loading map layout: " + err, "error"); }
    });
    ...
    // 🔑 FIXED: TOUCH SUPPORT FOR RESIZER
