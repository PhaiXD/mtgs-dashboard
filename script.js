document.addEventListener("DOMContentLoaded", () => {
    ...
    function logToConsole(msg, type='normal') {
        ...
        // 🔑 Smart Auto-Scroll: Check if user is near bottom
        ...
        // Scroll down only if already at bottom
    ...
    btnNewDbFile.addEventListener('click', async () => {
        ...
        if ('showSaveFilePicker' in window) {
            try {
                ...
                dbPathBox.classList.add('has-file'); // 🆕 Add Glow class
    ...
    dbClearBtn.addEventListener('click', (e) => {
        ...
        dbPathBox.classList.remove('has-file'); // 🆕 Remove Glow class
    ...
    // 🔑 3.1 Reveal File (Click Box -> Open File Dialog)
    dbPathBox.addEventListener('click', () => {
        if(isDbRecording) return;
        // User wants to "Reveal in explorer". Closest thing is to open the picker.
        // It lets them see the file system.
        btnOpenDbFile.click();
    });
    ...
    btnConnectDb.addEventListener('click', async () => {
        ...
        if (!isDbRecording) {
            ...
            if (!db) {
                ...
                // Note: Auto-gen files are virtual (in memory), so we don't add 'has-file' glow yet
            ...
            // 🆕 Show Warning Only if NOT auto-generated (User Opened File)
            if(!isAutoGenerated) {
